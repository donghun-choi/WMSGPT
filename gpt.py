...
api_key = str(env.load('OPENAI.APIKEY'))
...
def main():
    ...
    message_log = [
        {"role": "system", "content": "You are WMSGPT."},
        {"role": "system","content": "당신은 WMSGPT 입니다"}
    ]
    ...
    while True:
        if first_request:
            ...
            # If the user types "quit", end the loop and print a goodbye messag
